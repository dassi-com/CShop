...
// Composant modal extrait pour éviter les re-renders inutiles
const PaymentModal = ({ 
  isOpen, 
  onClose, 
  customerInfo, 
        ...
        <div className="p-6">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" name="fullName" value={customerInfo.fullName}
                  ...
                  placeholder="Jean Mbarga" required disabled={isProcessing} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" name="email" value={customerInfo.email}
                  onChange={onCustomerInfoChange}
                  className="w-full pl-10 p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-fuchsia-400"
                  placeholder="jean@email.com" required disabled={isProcessing} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="tel" name="phone" value={customerInfo.phone}
                  onChange={onCustomerInfoChange}
                  className="w-full pl-10 p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-fuchsia-400"
                  placeholder="+237 6XX XXX XXX" required disabled={isProcessing} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" name="address" value={customerInfo.address}
                  onChange={onCustomerInfoChange}
                  className="w-full pl-10 p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-fuchsia-400"
                  placeholder="Rue de la Réunification" required disabled={isProcessing} />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" name="city" value={customerInfo.city}
                  ...
                  placeholder="Yaoundé" required disabled={isProcessing} />
              </div>
              <div>
            ...
            <button type="submit" disabled={isProcessing}
              className={`w-full py-3 bg-fuchsia-500 hover:bg-fuchsia-600 text-white rounded-lg font-medium flex items-center justify-center gap-2 transition-colors ${isProcessing ? 'opacity-60 cursor-not-allowed' : ''}`}>
              {isProcessing ? (
  ...
  return (
    <div className="min-h-screen bg-black py-8">
      <div className="container mx-auto px-4">
        ...
        {/* 🔑 Composant modal avec toutes les props nécessaires */}
        <PaymentModal
